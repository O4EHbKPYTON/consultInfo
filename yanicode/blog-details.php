    ...
    <main class="website-workarea">
        <section class="">
            <div class="container blog_article">
                <img width="100%" height="100%" src="local/templates/main/assets/images/case-img4.jpg" alt="">
        ...
        <div class="container">
            <div class="footer-wrapper">
                <a href="./index.php" class="footer__logo">
                    <img width="232" height="71" src="local/templates/main/assets/images/svg/logo-yanicode.svg" alt="yanicode">
                </a>
